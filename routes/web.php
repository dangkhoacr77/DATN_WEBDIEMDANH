...
Route::middleware(['web'])->group(function () {
    ...
    Route::get('nguoidung/danhsach/{id}', [QLDanhsachController::class, 'show'])->name('nguoidung.ql-danhsach.chitiet');
    ...
    Route::put('/nguoidung/thong-tin-ca-nhan/{id}', [NguoidungTTCanhanController::class, 'update'])->name('nguoidung.tt-canhan.update');
