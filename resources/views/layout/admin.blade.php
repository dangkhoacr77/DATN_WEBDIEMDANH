        ...
        <div
            ...
            <div style="display: flex; flex-direction: column;">
                ...
                <div onclick="window.location.href='{{ route('admin.ql-bieumau') }}'"
                    style="padding: 12px 24px; display: flex; align-items: center; gap: 10px; font-size: 14px; {{ request()->is('admin/ql-bieumau') ? 'color: #0047ff; background-color: #eef3ff; font-weight: bold;' : 'color: #333;' }} cursor: pointer;">
                    📄 Biểu mẫu</div>
                <div onclick="window.location.href='{{ route('admin.ql-taikhoan') }}'"
                    style="padding: 12px 24px; display: flex; align-items: center; gap: 10px; font-size: 14px; {{ request()->is('admin/ql-taikhoan') ? 'color: #0047ff; background-color: #eef3ff; font-weight: bold;' : 'color: #333;' }} cursor: pointer;">
                    👤 Tài Khoản</div>
                <div onclick="window.location.href='{{ route('admin.tt-canhan') }}'"
                    style="padding: 12px 24px; display: flex; align-items: center; gap: 10px; font-size: 14px; {{ request()->is('admin/tt-canhan') ? 'color: #0047ff; background-color: #eef3ff; font-weight: bold;' : 'color: #333;' }} cursor: pointer;">
