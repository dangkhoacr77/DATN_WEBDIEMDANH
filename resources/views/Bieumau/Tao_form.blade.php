...
<div class="color-option w-6 h-6 bg-[#fca5a5] rounded-full cursor-pointer" data-color="Đỏ" data-code="#fca5a5"></div>
<div class="color-option w-6 h-6 bg-[#c4b5fd] rounded-full cursor-pointer" data-color="Tím" data-code="#c4b5fd"></div>
<div class="color-option w-6 h-6 bg-[#93c5fd] rounded-full cursor-pointer" data-color="Xanh dương đậm" data-code="#93c5fd"></div>
<div class="color-option w-6 h-6 bg-[#a5f3fc] rounded-full cursor-pointer" data-color="Xanh trời" data-code="#a5f3fc"></div>
<div class="color-option w-6 h-6 bg-[#fdba74] rounded-full cursor-pointer" data-color="Cam" data-code="#fdba74"></div>
<div class="color-option w-6 h-6 bg-[#fde68a] rounded-full cursor-pointer" data-color="Vàng đậm" data-code="#fde68a"></div>
<div class="color-option w-6 h-6 bg-[#99f6e4] rounded-full cursor-pointer" data-color="Xanh ngọc" data-code="#99f6e4"></div>
<div class="color-option w-6 h-6 bg-[#86efac] rounded-full cursor-pointer" data-color="Xanh lá" data-code="#86efac"></div>
<div class="color-option w-6 h-6 bg-[#d1d5db] rounded-full cursor-pointer" data-color="Xám nhạt" data-code="#d1d5db"></div>
                </div>
            </div>
        </div>
    </div>
       ...
       <div class="flex flex-col min-h-screen">
        <header class="bg-white shadow-sm py-4 px-6 flex items-center justify-between border-b">
            ...
            <div class="flex items-center space-x-4">
                <button onclick="window.location.href='{{ route('trangchu') }}'" class="text-gray-600 hover:text-indigo-600" title="Trang chủ">
    ...
    <div id="form-background"
         class="form-header-background relative"
