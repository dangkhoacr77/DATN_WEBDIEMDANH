  ...
  <div style="display: flex; min-height: 100vh;">
    ...
    <div style="width: 220px; background: white; padding: 30px 0; border-right: 1px solid #e0e0e0; display: flex; flex-direction: column;">
      ...
      <div style="display: flex; flex-direction: column;">
        ...
        <div onclick="window.location.href='{{ route('admin.tt-canhan') }}'" style="padding: 12px 24px; display: flex; align-items: center; gap: 10px; font-size: 14px; color: #0047ff; background-color: #eef3ff; font-weight: bold; cursor: pointer;">⚙️ Thông tin cá nhân</div>
      </div>
    </div>
          ...
          <form style="display: flex; flex-direction: column; gap: 24px;">
            <div style="display: flex; gap: 40px;">
              <div style="flex: 1; display: flex; flex-direction: column;">
                ...
                <input type="text" value="Lý Thanh Duy" readonly class="editable" style="padding: 10px 14px; border: 1.5px solid #e0e0e0; border-radius: 10px; background: #f9f9f9; font-size: 14px; color: #111;">
              </div>
              <div style="flex: 1; display: flex; flex-direction: column;">
                <label style="margin-bottom: 8px; font-weight: 500; font-size: 14px;">Số điện thoại</label>
                <input type="text" value="0312546971" readonly class="editable" style="padding: 10px 14px; border: 1.5px solid #e0e0e0; border-radius: 10px; background: #f9f9f9; font-size: 14px; color: #111;">
              </div>
            </div>
            ...
            <div style="display: flex; gap: 40px;">
              <div style="flex: 1; display: flex; flex-direction: column;">
                ...
                <input type="email" value="lythanhduy@gmail.com" readonly class="editable" style="padding: 10px 14px; border: 1.5px solid #e0e0e0; border-radius: 10px; background: #f9f9f9; font-size: 14px; color: #111;">
              </div>
              <div style="flex: 1; display: flex; flex-direction: column;">
            ...
            <div style="display: flex; gap: 40px;">
              <div style="flex: 1; display: flex; flex-direction: column;">
                ...
                <input type="text" value="01/01/2004" readonly class="editable" style="padding: 10px 14px; border: 1.5px solid #e0e0e0; border-radius: 10px; background: #f9f9f9; font-size: 14px; color: #111;">
              </div>
              <div style="flex: 1;"></div>
            </div>

            <button id="editButton" type="button" style="align-self: flex-end; margin-top: 20px; background-color: #0047ff; color: white; padding: 12px 24px; border: none; border-radius: 10px; font-weight: bold; font-size: 14px; cursor: pointer;">Chỉnh sửa</button>
          </form>
        </div>
      </div>
    </div>
