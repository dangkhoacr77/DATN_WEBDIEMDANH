...
@section('content')
    <div style="background: white; border-radius: 16px; padding: 40px; max-width: 100%; width: 95%; margin: auto;">
        ...
        <div class="custom-pagination"
            style="display: flex; justify-content: center; gap: 8px; flex-wrap: wrap; margin-top: 24px;"></div>
    </div>
@endsection
        ...
        function renderFormTable() {
            ...
            rows.forEach(row => {
                ...
                tr.innerHTML = `
                                ...
                                <td style="padding:12px;">
                                    <button type="button"
                                        style="border:none;background:none;color:#0d6efd;cursor:pointer;"
                                        onclick="window.location.href='bieumau/tao/${row.ma_bieu_mau}'">
